= Active Resource {<img src="https://travis-ci.org/rails/activeresource.svg?branch=master" alt="Build Status" />}[https://travis-ci.org/rails/activeresource]
...
See {CONTRIBUTING}[https://github.com/rails/activeresoure/blob/master/CONTRIBUTING.md].
